  ...
  return (
    <div className={className}>
      ...
      <div className="section-container">
        <ForumSection className="forum-section" name="Раздел1" user="Дмитрий Козицкий" timestamp="12:05:47 22/04/2023" childrenElements={topics}/>
        <ForumSection className="forum-section" name="Раздел2" user="Дмитрий Козицкий" timestamp="12:05:47 22/04/2023" childrenElements={topics1}/>
        <ForumSection className="forum-section" name="Раздел3" user="Дмитрий Козицкий" timestamp="12:05:47 22/04/2023" childrenElements={topics1}/>
      </div>     
    </div>
  )
}
